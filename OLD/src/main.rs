...
fn app_startup(application: &gtk::Application) {
    ...
    let full_container = BoxBuilder::new()
        ...
        .vexpand(true)
        .build();
    full_container.set_hexpand(true);
    full_container.set_vexpand(true);
    full_container.set_valign(gtk::Align::Fill);

    let second_row_container = BoxBuilder::new()
        .name("second_row")
        .orientation(gtk::Orientation::Vertical)
        .width_request(1920)
        // .height_request(1080)
        ...
        .build();
    second_row_container.set_hexpand(true);
    second_row_container.set_vexpand(true);
    second_row_container.set_valign(gtk::Align::Fill);
    ...
    search_container.set_vexpand(true);
    ...
    full_container.add(&extraInfoBox);
    second_row_container.add(&search_container);
    second_row_container.add(&tips_box);
    ...
    let listbox = ListBoxBuilder::new().name(LISTBOX_NAME).vexpand(true).build();
    ...
    full_container.add(&second_row_container);
    window.set_child(Some(&full_container));
    window.show_all()
}
